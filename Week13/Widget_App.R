...
ui <- fluidPage(
    ...
    radioButtons("radio", label=h3("Starting Number:"),
                 choices=list("Start with 1"=1,"Start with 2"=2,"Start with 3"=3,"Start with 4"=4,"Start with 5"=5,"Start with -3"=-3, "Start with -2"=-2,"Start with -1"=-1), 
                 selected = -1),
    hr(),
    
    #Select Box input
    selectInput("select", label = h3("Multiply by?"), 
                choices=list("Times 1"=1, "Times 2"=2, "Times 3"=3), 
                selected = 1),
    hr()),
